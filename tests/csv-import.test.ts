...
import { createProfessor, resetDb } from "./helpers";
...
describe("importRoster", () => {
  ...
  it("updates existing users and reassigns teams without touching role or password", async () => {
    ...
    expect(joe?.membership?.team.name).toBe("Beta");
  });
